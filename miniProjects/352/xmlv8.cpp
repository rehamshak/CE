...
void attr(int hwnd, char *src , int st,int le);
...
int main()
{
 ...
 // args[2]='c'
		...
		char args='e'; /* This parameter will define the work of the main program through it's three values 
...
int  XMLFILE(  char * source,char cmd,char *buffer)
{
  ...
  cout <<" analyze the Code :";
    ...
    start:
	/////////////////////////////|  Checking .. file xml is a valid and set attributes |\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
